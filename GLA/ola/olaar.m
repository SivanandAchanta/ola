function Y = olaar(X,sShift,hWindow,Dim)
% ola       - Overlap and Add using Allen & Rabiner's method
%
%   Y = olaar(X,sShift,hWindow,Dim)
%
%   Performs the overlap and add method on the input matrix X to create the
%   output array Y using Allen & Rabiner's method.
%
%   Example
